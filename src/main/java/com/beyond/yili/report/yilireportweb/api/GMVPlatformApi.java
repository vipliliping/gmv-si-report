...
/**
 * @author vipliliping
 * @create 2019/4/23 16:31
 * @desc
 **/
@Controller
@Api(
        value = "GMV平台明细",
        description = "GMV平台明细Api"
)
public class GMVPlatformApi {
    private static final Logger log = LoggerFactory.getLogger(GMVPlatformApi.class);
    private String[] cols = new String[]{"平台", "店铺", "品类", "品牌", "SKU", "成交商品件数(单位:件)", "成交金额(单位:万元)", "平均件单价(单位:元/件)"};
    ...
    @RequestMapping(
            value = {"/gmv/plat/detail"},
            method = {RequestMethod.POST},
            produces = {"application/json;charset=UTF-8"}
    )
    @ResponseBody
    public Object gmvPlat(@ApiParam(name = "params",hidden = true) Map<String, Object> params, TreeGridRequestEnum typeEnum, String level, String treeValue, String date, String timeWD, String cates, String brands, String skus, String ranks, String plats, String shops) throws Exception {
        ...
        switch(typeEnum) {
            ...
            case BODY:
                ...
                List<Map<String, String>> dataList = this.treeGridInfra.queryKylinDataByTemplateForTree(params, treeGridHead.getId(), treeGridHead.getParentId(), this.colKeys, "GMV/GMV平台明细.ftl", level, treeValue);
                return dataList;
            default:
