...
$(document).ready(function () {
    ...
    $('.gmv_si_btn').on('click', function () {
        ...
        $(this).addClass('active')
        var url = value=='gmv'?"gmv/plat/detail":"si/plat/detail"

        $("#titleSpan").html(value=='gmv'?"GMV数据：平台视角明细表":"SI数据：平台视角明细表");
    ...
    $('#returnBtn').on('click',function (e) {
        ...
        var siUrl = baseurl + $("#yili-token").val()+'#/nv/dashboard//1d279af077974fa5a07b7e49de01a95f'
        var gmvUrl = baseurl + $("#yili-token").val()+'#/nv/dashboard//bfa3af3889ff44d89756e771d4a11e72'
